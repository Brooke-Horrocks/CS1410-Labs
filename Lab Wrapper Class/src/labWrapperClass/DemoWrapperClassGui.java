...
public class DemoWrapperClassGui extends JFrame {
    ...
    private JRadioButton binaryOctHex;
    ...
    private void createNumberControlPanel() {
        ...
        minMax = new JRadioButton("Min Max");
        minMax.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		numberTextArea.setText(dwc.minMax());
        	}
        });
        buttonGroup_1.add(minMax);
        numberControlPanel.add(minMax);
        
        binaryOctHex = new JRadioButton("Binary Oct Hex");
        binaryOctHex.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		numberTextArea.setText(dwc.toBinary(15));
        	}
        });
        buttonGroup_1.add(binaryOctHex);
        numberControlPanel.add(binaryOctHex);
    }
    ...
    private void createCharControlPanel() {
        ...
        txtSubmit = new JTextField("Submit");
        txtSubmit.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		charTextArea.setText(dwc.charProperties(txtSubmit.getText().charAt(0)));
        	}
        });
        charControlPanel.add(txtSubmit);
    }
